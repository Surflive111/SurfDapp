...
function TimeMenu() {
    ...
    const SURF_ADDRESS = addresses.SURF_ADDRESS;
                ...
                {({ TransitionProps }) => (
                    <Fade {...TransitionProps} timeout={200}>
                        <div className="tooltip">
                            <Link className="tooltip-item" href={`https://poocoin.app/tokens/0x6cbd8ecaf789324233039fdb8711a29f3f8d0a61`} target="_blank">
                                <p>Buy on Poocoin</p>
                            </Link>
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("SURF", SURF_ADDRESS)}>
                                        <p>SURF</p>
                                    </div>
                                </div>
                            )}
